    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="样式" name="style">
        <el-collapse accordion>
          ...
          <el-collapse-item v-if="item.option.series.length !== 0" title="图表区域颜色">
            <el-form ref="form" :model="item" label-width="35%" size="mini">
              <el-form-item v-for="(series, index) in item.option.series" :key="series.name" :label="'区域颜色(' + (index + 1) + ')'">
                <el-col :span="20">
                  <el-color-picker v-model="series.areaStyle.color" />
                </el-col>
              </el-form-item>
            </el-form>
          </el-collapse-item>
